...
int main()
{
	...
	do
	{
		...
		//When redo is not displayed and play is not displayed
		//Redo is displayed and play is not displayed
		//redo is not displayed and play is displayed
		//redo is displayed and play is displayed

		char menuText1[MAXCOLS] = { "<A>nimate: N / <U>ndo: 0 / Cl<I>p: 0\n" };

		if (undoList.count >= 0 && clips.count < 2 && redoList.count == 0)
		{
			snprintf(menuText1, MAXCOLS, "<A>nimate: N / <U>ndo: %d / Cl<I>p: %d\n", undoList.count, clips.count);
		}
		if (undoList.count >= 0 && redoList.count > 0 && clips.count < 2)
		{
			snprintf(menuText1, MAXCOLS, "<A>nimate: N / <U>ndo: %d / Red<O>: %d / Cl<I>p: %d\n", undoList.count, redoList.count, clips.count);
		}
		if (undoList.count >= 0 && redoList.count == 0 && clips.count >= 2)
		{
		...
		/*if (undoList.count >= 0 && clips.count < 2)
		{
			snprintf(menuText1, MAXCOLS, "<A>nimate: N / <U>ndo: %d / Cl<I>p: %d \n", undoList.count, clips.count);
			if (redoList.count > 0)
			{
			...
			else if (undoList.count >= 0 && clips.count < 2)
			{
				snprintf(menuText1, MAXCOLS, "<A>nimate: N / <U>ndo: %d / Cl<I>p: %d \n", undoList.count, clips.count);
			}
		}
